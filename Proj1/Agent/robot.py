...
class Rob(CRobLinkAngs):
    def __init__(self, rob_name, rob_id, angles, particle_count, host):
        ...
        self.out_right = 0
        self.noise = 1 
        self.sensor_angle = 60  # sensor opening range (cone angle)
        ...
        [
            # multiplying by 2 as each cell is twice the diameter of the robot
    ...
    def updateParticlesWithMeasures(self, distances):
        ...
        for (x, y, theta) in unique_particles:
            ...
            # we want uncertainty so weight != 0
            weight = 0.1
            ...
            for sid in sensor_ids:
                ...
                # TODO: incolplete need to find corners, get smallest diff to distances and increase weight
